...
**Status:** 🚧 - **Last Updated:** 16th April 2026

- [Using AI effectively](#using-ai-effectively)
  - [MCP Server](#mcp-server)
    - [✅ **Figma MCP Server**](#-figma-mcp-server)
  - [Skills, Tools and Resources to use AI effectively](#skills-tools-and-resources-to-use-ai-effectively)
    - [✅ **Tools**](#-tools)
    - [✅ **Skills**](#-skills)
